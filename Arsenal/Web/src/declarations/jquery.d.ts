...
interface JQueryGenericPromise<T> {
  ...
  then<U>(
    onFulfill: (value: T) => JQueryGenericPromise<U>,
    onReject?: (reason) => JQueryGenericPromise<U>,
...
interface JQueryPromise<T> {
  ...
  then<U>(
    onFulfill: (value: T) => U,
    onReject?: (...reasons) => JQueryGenericPromise<U>,
    onProgress?: (...progression) => any,
  ): JQueryPromise<U>;
  then<U>(
    onFulfill: (value: T) => JQueryGenericPromise<U>,
  ...
  then<U>(
    onFulfill: (...values) => JQueryGenericPromise<U>,
    onReject?: (...reasons) => U,
    onProgress?: (...progression) => any,
  ): JQueryPromise<U>;
  then<U>(
